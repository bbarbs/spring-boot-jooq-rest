...
public interface ITablePrivileges extends Serializable {
     ...
     */
    public void from(com.jooq.information_schema.tables.interfaces.ITablePrivileges from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ITablePrivileges
     */
    public <E extends com.jooq.information_schema.tables.interfaces.ITablePrivileges> E into(E into);
}
